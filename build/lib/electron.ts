...
export const config = {
	...
	copyright: 'Copyright (C) 2026 Nyrve contributors. All rights reserved',
	darwinExecutable: product.nameShort,
	darwinIcon: 'resources/darwin/nyrve.icns',
	darwinBundleIdentifier: product.darwinBundleIdentifier,
	darwinApplicationCategoryType: 'public.app-category.developer-tools',
	darwinHelpBookFolder: 'Nyrve HelpBook',
	darwinHelpBookName: 'Nyrve HelpBook',
	darwinBundleDocumentTypes: [
		...
		...darwinBundleDocumentTypes({
			...
			'Nyrve workspace file': 'code-workspace',
	...
	winIcon: 'resources/win32/nyrve.ico',
