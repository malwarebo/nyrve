...
export const ADVANCED_SETTINGS = {
	contextTokenBudget: 'forge.context.defaultTokenBudget',
	backgroundDailyBudget: 'forge.backgroundAgent.dailyTokenBudget',
	taskDailyBudget: 'forge.tasks.dailyTokenBudget',
	memoryMaxEntries: 'forge.memory.maxEntries',
	memoryDecayDays: 'forge.memory.decayDays',
} as const;
