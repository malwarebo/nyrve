...
export class ForgeComplexityAnalyzer {
	constructor(
	...
	async analyze(): Promise<ComplexityResult> {
		this.logService.info('[Forge] Complexity analyzer: scanning for tech debt and complexity...');
		...
		this.logService.info(
			`[Forge] Complexity analyzer: ${largestFiles.length} large files, ` +
