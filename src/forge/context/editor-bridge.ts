...
export const IForgeEditorBridge = createDecorator<IForgeEditorBridge>('forgeEditorBridge');

export interface IForgeEditorBridge {
...
export class ForgeEditorBridge extends Disposable implements IForgeEditorBridge {
...
registerSingleton(IForgeEditorBridge, ForgeEditorBridge, InstantiationType.Delayed);
