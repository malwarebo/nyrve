...
export const INyrveProgressTracker = createDecorator<INyrveProgressTracker>('nyrveProgressTracker');

export interface INyrveProgressTracker {
...
export class NyrveProgressTracker extends Disposable implements INyrveProgressTracker {
...
registerSingleton(INyrveProgressTracker, NyrveProgressTracker, InstantiationType.Delayed);
