...
import { app, Details, GPUFeatureStatus, nativeImage, powerMonitor, protocol, session, Session, systemPreferences, WebFrameMain } from 'electron';
	...
	async startup(): Promise<void> {
		...
		if (isMacintosh && app.dock) {
			try {
				...
				this.logService.warn('Failed to set dock icon:', error);
			}
		}
